...
# with command line options: step3 --conditions auto:phase2_realistic -n 10 --era Phase2C4 --eventcontent FEVTDEBUGHLT --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM --datatier GEN-SIM-RECO --geometry Extended2023D28 --filein file:step2.root --fileout file:step3.root --outputCommands keep *_HGCalUncalibRecHit_*_*,keep *_HGCDigis*_*_*,keep *_hgcalDigis*_*_* --no_exec
