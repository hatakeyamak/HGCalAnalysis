...
bash cmsRun ../../step2_DIGI_L1_L1TrackTrigger_DIGI2RAW_HLT_KH.py inputFiles='root://kodiak-se.baylor.edu//store/user/hatake/crab_outputs/TTbar_14TeV/CMSSW_10_3_X_2018-07-30-2300_Step1_v1/180731_232243/0000/step1_'${1}'.root' outputFile='file:step2_'${1}'.root' maxEvents=10
bash cmsRun ../../step3_RAW2DIGI_L1Reco_RECO_RECOSIM_PAT_VALIDATION_DQM_KH.py inputFiles='file:step2_'${1}'.root' outputFile='file:step3_'${1}'.root' outputMINIAOD='file:step3_inMINIAOD_'${1}'.root' outputDQM='file:step3_inDQM_'${1}'.root'  maxEvents=10
foreach f (`ls *.root`)
   echo $f
