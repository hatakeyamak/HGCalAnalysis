...
HGCalTupleMaker_Tree::HGCalTupleMaker_Tree(const edm::ParameterSet& iConfig) {
  ...
  edm::ProductSelectorRules productSelectorRules_(iConfig, "outputCommands", "HGCalTupleMaker_Tree");
    ...
    if(productSelector_.selected(*selection)) {
      ...
      if (branchnames.find( selection->productInstanceName()) != branchnames.end() ) {
        throw edm::Exception(edm::errors::Configuration)
          ...
          << "Exception thrown from HGCalTupleMaker_Tree::HGCalTupleMaker" << std::endl;
      }
      else {
      ...
      default:
        {
          ...
          throw edm::Exception(edm::errors::Configuration)
            ...
            <<   leafstring
            << "Exception thrown from HGCalTupleMaker_Tree::HGCalTupleMaker\n";
        }
      }
    }
  }
