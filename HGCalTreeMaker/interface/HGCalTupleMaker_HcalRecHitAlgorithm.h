#ifndef HGCALTUPLEMAKER_RECHITALGORITHM_H
#define HGCALTUPLEMAKER_RECHITALGORITHM_H
...
class HGCalTupleMaker_HcalRecHitAlgorithm { 

 public:

  HGCalTupleMaker_HcalRecHitAlgorithm();
